...
WebDriver driver;
	...
	@FindBy(xpath = "//a[contains(text(),'Download Invoice')]") public WebElement downloadInvoice;
	
	@FindBy(xpath = "//a[contains(text(),'Continue')]") public WebElement continueBtn1;
	
	@FindBy(xpath = "//header/div[1]/div[1]/div[1]/div[2]/div[1]/ul[1]/li[5]/a[1]") public WebElement deleteAcc;
	...
	public void downloadInvoice(String SearchInput) {
		try {
	...
	driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));
	zipcode.sendKeys("56678788");
	driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));
	mobileNum.sendKeys("56778775");
	driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));
